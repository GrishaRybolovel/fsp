# Generated by Django 4.0.6 on 2023-07-17 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.CharField(blank=True, choices=[('CA', 'Карта'), ('BC', 'Юр. лицо'), ('CS', 'Наличные')], default='CA', max_length=3, null=True, verbose_name='Способ оплаты')),
                ('shipping_address', models.CharField(blank=True, max_length=1024, null=True, verbose_name='Адрес доставки')),
                ('way_of_shipping', models.CharField(blank=True, choices=[('CA', 'Самолет'), ('BC', 'Поезд'), ('KU', 'Курьер'), ('SA', 'Самовывоз')], default='SA', max_length=3, null=True, verbose_name='Способ доставки')),
